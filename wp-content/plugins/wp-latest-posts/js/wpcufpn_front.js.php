...
(function($) {
 $(document).ready(function(){
	  ...
	  var $window = $(".wpcufpn_outside.wpcufpn_widget_<?php echo (int)$_GET['id']; ?>"),flexslider;
	 ...
	 switch($_GET['pagination']){
	  case "0":
		  $nav = " controlNav: false,directionNav: false";
	  break;
	  case '1':
		  $nav = " controlNav: false,directionNav: true";
	  break;
	  case '2':
		  $nav = " controlNav: true,directionNav: true";
	  break;
	  case '3':
		  $nav = " controlNav: true,directionNav: false";
	  break;
	 }
			// 0 = None
			// 1 = Arrows
	...
	switch($_GET['autoanimate']){
	  case "0":
		  $autoanmi = " slideshow:false,";
	  break;
	  case '1':
		  $autoanmi = " slideshow:true,";
	  break;
	 }
			// 0 = off 
			// 1 = on
			
	switch($_GET['autoanimatetrans']){
	  case "0":
		  $autoanmitrans = ' animation: "fade",';
	  break;
	  case '1':
	...
	$slideshowspeed=' slideshowSpeed: 7000,';	
	 ...
	 ?>
	  ...
	  $(window).load(function() {
	    $("#wpcufpn_widget_<?php echo (int)$_GET['id']; ?>").flexslider({
