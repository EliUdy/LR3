...
class wpcuFPN_Front {
    ...
    public function loadThemeScript() {
        ...
        if($this->widget->settings['theme'] == 'masonry' || $this->widget->settings['theme'] == 'masonry-category' || $this->widget->settings['theme'] == 'smooth-effect' || $this->widget->settings['theme'] == 'timeline' || $this->widget->settings['theme'] == 'portfolio'){
            $theme_root = '';
            $dirs = apply_filters('wpcufpn_plugindir',$theme_root);
        ...
        if ($theme_dir == 'masonry' || $theme_dir == 'masonry-category') {
            wp_enqueue_script(
                    'wpcufpn_addon_front', plugins_url("wp-latest-posts-addon/js") . "/wpcufpn_addon_front.js", array('jquery'), '0.1', true
            );
            wp_enqueue_script(
                    'wpcufpn_addon_imagesloaded', plugins_url('js/imagesloaded.pkgd.min.js', dirname(__FILE__)), array('jquery'), '0.1', true
            );
        }
        ...
        if (file_exists($theme . '/script.js')) {
            ...
            wp_enqueue_script('scriptdefault-wplp', plugins_url("wp-latest-posts/js/") . "/wpcufpn_front.js", array('jquery'), '1.0', true);
            $data_array= array(
                'id' => $id,
                'pagination' =>$pagination,
                'autoanimate' => $autoanimate,
    ...
    public function loadThemeStyle() {
        ...
        if (file_exists($theme . '/style.css')) {
            ...
            if (($theme_classDashicon != " default")) {
                $hanlde = 'themes-wplp-' . $this->widget->settings['theme'];
                wp_enqueue_style($hanlde, plugins_url("wp-latest-posts-addon/themes/") . $theme_dir . "/style.css");
                $css = "";
                $widthtotal = 90;
                $width1=$widthtotal/$nbcol;
                $width2=($nbcol==1?$widthtotal:$widthtotal/2);
                if($theme_classDashicon == ' masonry-category'){
                    $css .= ".wpcufpn_widget_masonry-category .wpcufpn_listposts li .img_cropper:before{background: center center no-repeat ".$colorfull."} ";
                    $css .= ".wpcufpn_widget_masonry-category .masonry-category .wpcu-front-box.bottom .category:before{background:".$color."}";
                    $css .= ".wpcufpn_widget_masonry-category .read-more{border-top:1px solid ".$color."}";
                    $css .= ".wpcufpn_widget_masonry-category .wpcufpn_listposts li{ width: ".$width1."%;}";
                    $css .= "@media screen and (max-width: 640px) {.wpcufpn_widget_masonry-category .wpcufpn_listposts li {width: ".$width2."% !important; }}";
                }elseif($theme_classDashicon == ' masonry'){
                    $css .= ".wpcufpn_widget_masonry .wpcufpn_listposts li .img_cropper:before{background: url(\"img/overimage.png\") center center no-repeat ".$color.";}";
                    $css .= ".wpcufpn_widget_masonry .read-more{border-top:1px solid ".$color.";}";
                    $css .= ".wpcufpn_widget_masonry .wpcufpn_listposts li{width: ".$width1."%;}";
                    $css .= "@media screen and (max-width: 640px) {.wpcufpn_widget_masonry .wpcufpn_listposts li {width: ".$width2."% !important;}}";
                }elseif($theme_classDashicon == ' portfolio'){
                    if($colorTheme == 'no'){
                        $css .= ".wpcufpn_widget_portfolio .wpcufpn_listposts{background-color: ".$colorfull."}";
                    }
                    $css .= ".wpcufpn_widget_portfolio .portfolio .wpcu-front-box.bottom .category::before{ background:".$color.";}";
                    $css .= ".wpcufpn_widget_portfolio .read-more{border-top:1px solid ".$color.";}";
                    $css .= ".wpcufpn_widget_portfolio .wpcufpn_listposts li{margin-left: ".($width1/10)."%;margin-top: ".($width1/20)."%; margin-bottom: ".($width1/20)."%; width: ".$width1."%;}";
                    $css .= "@media screen and (max-width: 640px) {.wpcufpn_widget_portfolio .wpcufpn_listposts li {width: ".$width2."% !important;}}";
                    $css .= ".wpcufpn_widget_portfolio .wpcufpn_listposts {background: center center no-repeat ".$colorfull.";background-color: ".$colorfull.";}";
                }elseif($theme_classDashicon == ' smooth-effect'){
                    $css .= ".wpcufpn_widget_smooth-effect li.smooth-effect:hover .wpcu-front-box a .title { border-top: 1px solid ".$color.";}";
                    $css .= ".wpcufpn_widget_smooth-effect li.smooth-effect:hover .wpcu-front-box a .text { border-bottom: 1px solid ".$color.";}";
                    ...
                    $css .= ".wpcufpn_widget_timeline .wpcufpn_listposts  .wpcu-front-box.top .img_cropper:before {color:".$innercolor."; background:".$colorfull.";}";
                }
                wp_add_inline_style($hanlde, $css);

                if ($theme_classDashicon == " masonry-category") {
                    if (isset($this->widget->settings['force_icon']) && $this->widget->settings['force_icon'] == 1) {
                        if (isset($this->widget->settings['dashicons_selector'])) {
                            if ($this->widget->settings['dashicons_selector'] == '') {
                                $str = '';
                                $str .= "#wpcufpn_widget_" . $this->widget->ID . " .wpcufpn_listposts li .img_cropper:before {";
                                $str .= "content: none ;";
                                $str .= "}";
                                ...
                                $str = '';
                                $str .= "#wpcufpn_widget_" . $this->widget->ID . " .wpcufpn_listposts li .img_cropper:before {";
                                $str .= "content:'\\" . $this->widget->settings['dashicons_selector'] . "';";
                                $str .= "}";
                                wp_add_inline_style($hanlde, $str);
                            }
                        }
                ...
                if ($theme_classDashicon == " masonry") {
                    if (isset($this->widget->settings['force_icon']) && $this->widget->settings['force_icon'] == 1) {
                        if (isset($this->widget->settings['icon_selector'])) {
                            if ($this->widget->settings['icon_selector'] == '') {
                                $str = '';
                                $str .= "#wpcufpn_widget_" . $this->widget->ID . " .wpcufpn_listposts li .img_cropper:before {";
                                ...
                                $str = '';
                                $str .= "#wpcufpn_widget_" . $this->widget->ID . " .wpcufpn_listposts li .img_cropper:before {";
                                $str .= "background: url('" . $this->widget->settings['icon_selector'] . "')  center no-repeat rgba(255,0,0,0.7);";
                                $str .= "}";
                                wp_add_inline_style($hanlde, $str);
                            }
                        }
    ...
    private function container($is_sidebar_widget = false) {
        ...
        /** Container div * */
        $this->html .= '<div id="wpcufpn_widget_' . $this->widget->ID . '" class="wpcufpn_widget_'.basename($this->widget->settings['theme']).' wpcufpn_container ' . $orientation . $themedefaut . $theme_class . $theme_classpro . $amount_cols_class . '" data-post="' . $this->widget->ID . '" style="' . $style_cont . '" >';
    ...
    private function field($field) {
        ...
        if ('Thumbnail' == $field) {
            ...
            if(is_multisite()){
                $blog_id = '';
                if(isset($this->widget->settings['source_type'])){
                    if('src_page' == $this->widget->settings['source_type']){
                        $blog_id = $this->widget->settings['mutilsite_page'];
                    }elseif('src_category' == $this->widget->settings['source_type']){
                        $blog_id = $this->widget->settings['mutilsite_cat'];
                    }elseif('src_tags' == $this->widget->settings['source_type']){
                        $blog_id = $this->widget->settings['mutilsite_tag'];
                    }elseif('src_custom_post_type' == $this->widget->settings['source_type']){
                        $blog_id = $this->widget->settings['mutilsite_custompost'];
                    }
                }
            }
