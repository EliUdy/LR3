...
= 3.7.0 : =
* Add Material design admin interface
* Add Image upload new form

= 3.6.1 : =
* Fix fatal error on front-end, free version

= 3.6.0 : =
* Add option to display the post category
* Add an option to display a message when there's no post found
* Advanced Custom Fields (ACF) full integration - PRO version
* Load posts from latest: hours, days, months, years - PRO version
...
* Add RTL content support

= 3.5.1 : = 
* Add loader when admin interface loading
* Add option for image's position on default theme: center, left, right
...
* Fix issue option feature image in image source don't work
