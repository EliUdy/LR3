...
#wpcufpn_widget_<?php echo $_GET['id']; ?> .wpcufpn_listposts .masonry a {
    border: 0px;
}
...
#wpcufpn_widget_<?php echo $_GET['id']; ?> .wpcufpn_listposts li .img_cropper:before {
	...
	bottom:0;
	right:0;
	background: url("img/overimage.png") center center no-repeat <?php echo $_GET['color']; ?>;		
}
